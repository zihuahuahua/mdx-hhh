...
// 立方体 CubeGeometry(width, height, depth, segmentsWidth(x方向上的分段数(可选)), segmentsHeight(y方向上的分段数(可选)), segmentsDepth(z方向上的分段数(可选)), materials, sides)
